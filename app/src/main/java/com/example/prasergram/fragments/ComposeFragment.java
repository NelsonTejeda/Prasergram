...
import com.example.prasergram.LoginActivity;
import com.example.prasergram.MainActivity;
import com.example.prasergram.Post;
import com.example.prasergram.R;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnTakePhoto = view.findViewById(R.id.buttonTakePhoto);
        btnSubmit = view.findViewById(R.id.buttonSubmit);
        ivPostImage = view.findViewById(R.id.imageView2);
